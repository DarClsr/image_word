...
| **分类** | GET | `/api/category/styles` | 风格列表 |
| | GET | `/api/category/models` | 模型列表 |
| **作品** | POST | `/api/works` | 创建作品（提交生成任务） |
| | GET | `/api/works` | 我的作品列表 |
| | GET | `/api/works/:id` | 作品详情 |
| | DELETE | `/api/works/:id` | 删除作品 |
| | GET | `/api/works/public` | 公开作品广场 |
| **任务** | GET | `/api/task/:taskId` | 查询任务状态 |
